...
# Для кого книга?
- Для тех, кто хоть как-то знает, как программировать вообще или знает какой-то из языков: (или им подобным): Python, JavaScript, Swift, Go, C#…

> *Лично я хорошо знаю Python и JavaScript.

> Если вы полный ноль в программировании как таковом и решились учить С++ (не рекомендовано учить его первым), то прочтите мою же книгу «C++ From Scratch (Bozich)». Где, собственно, вы изучите С++ сравнивая его со Scratch. Но это будут основы основ (подобно одноименному разделу этой книги) (далее можете приступить к этой книге).
